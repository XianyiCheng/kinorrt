...
def test_kinorrt_cases(stability_solver, max_samples = 100):
    ...
    rrt_tree = RRTManipulationStability(X, x_init, x_goal, environment(app.collision_manager), the_object, manipulator,
...
for i in range(10):
    ...
    ti = test_kinorrt_cases(stability_solver, max_samples=100)
    times.append(ti)
    print(i)
print(times)
